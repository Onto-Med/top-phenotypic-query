...
/**
 * The <b>PlusYears-function</b> adds the given number of years (2. argument) to the given date (1.
...
public class PlusYears extends FunctionEntity {
  ...
  private PlusYears() {
    super("plusYears", NotationEnum.PREFIX, 2, 2);
  }

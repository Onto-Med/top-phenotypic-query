...
public class C2R {
  ...
  private void init() {
    ...
    addConstant(care.smith.top.top_phenotypic_query.c2reasoner.constants.Gt.get());
    addConstant(care.smith.top.top_phenotypic_query.c2reasoner.constants.Ge.get());
    addConstant(care.smith.top.top_phenotypic_query.c2reasoner.constants.Lt.get());
    addConstant(care.smith.top.top_phenotypic_query.c2reasoner.constants.Le.get());
    addFunction(Add.get());

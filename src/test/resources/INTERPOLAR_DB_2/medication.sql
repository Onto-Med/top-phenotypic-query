...
INSERT INTO db_log.medicationrequest (medreq_id, medreq_encounter_ref, medreq_patient_ref,
...
INSERT INTO db_log.medicationstatement (medstat_id, medstat_encounter_ref, medstat_patient_ref,

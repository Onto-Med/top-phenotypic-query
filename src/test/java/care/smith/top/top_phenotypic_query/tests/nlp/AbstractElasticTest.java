...
public abstract class AbstractElasticTest {
     ...
     * <ul>
     *     <li>_id: 01, _source: {name: test01, text: What do we have here? A test document. With an entity. Nice.},</li>
     *     <li>_id: 02, _source: {name: test02, text: Another document is here. It has two entities.},</li>
     *     <li>_id: 03, _source: {name: test03, text: And a third document; but this one features nothing.}</li>
     * </ul>
     */

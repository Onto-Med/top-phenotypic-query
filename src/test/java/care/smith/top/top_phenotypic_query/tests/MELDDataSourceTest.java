...
public class MELDDataSourceTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(MELDDataSourceTest.class);

  private static final DataAdapterConfig CONFIG =
      DataAdapterConfig.getInstanceFromResource("config/Data_Source_SQL_Adapter.yml");

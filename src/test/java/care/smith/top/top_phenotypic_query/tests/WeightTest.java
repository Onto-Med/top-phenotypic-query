...
public class WeightTest {
  ...
  public void test() throws InstantiationException {
    ...
    assertEquals(Set.of("weight_values_heavy"), phes2.getPhenotypeNames());
    assertEquals(
        BigDecimal.valueOf(110),
        Values.getNumberValue(phes2.getValues("weight_values_heavy", null).get(0)));

    SubjectPhenotypes phes4 = rs.getPhenotypes("4");
    assertEquals(Set.of("weight_values_heavy"), phes4.getPhenotypeNames());
    assertEquals(
        BigDecimal.valueOf(180),
        Values.getNumberValue(phes4.getValues("weight_values_heavy", null).get(0)));
  }

...
public class FHIRDelirTestIntern {
  ...
  private ResultSet execute(Phenotype p) throws InstantiationException {
    ...
    URL configFile =
        Thread.currentThread()
            ...
            .getResource("config/Delir_FHIR_Adapter_Test.yml");
  ...
  public void testAlgA() throws InstantiationException {
    ...
    assertEquals(Set.of("1", "5", "8"), getDBIds(rs.getSubjectIds()));
  }
  ...
  public void testAlgB() throws InstantiationException {
    ...
    assertEquals(Set.of("1", "2", "5", "6", "8", "10", "11"), getDBIds(rs.getSubjectIds()));
  }

  @Test
  public void test2of3() throws InstantiationException {
    ResultSet rs = execute(fact2of3);
    assertEquals(Set.of("2", "3", "4", "10"), getDBIds(rs.getSubjectIds()));
  }

...
public class FHIRClientTestIntern {
  ...
  private static void convert() throws SQLException {
    ...
    for (Map<String, Object> subject : subjects) {
      ...
      String obsId = (String) subject.get("assessment_id");
      LocalDateTime date = ((Timestamp) subject.get("created_at")).toLocalDateTime();
      BigDecimal height = (BigDecimal) subject.get("height");
      BigDecimal weight = (BigDecimal) subject.get("weight");

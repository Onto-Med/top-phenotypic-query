...
public class DefaultSqlWriter {
  ...
  private static final String CREATE_PHE =
      "CREATE TABLE phenotype (\r\n"
          + "    phenotype_id    bigint                   NOT NULL GENERATED BY DEFAULT AS"
          + " IDENTITY,\r\n"
  ...
  public void printPhe(PrintStream stream) {
    tablePrinter.print("phenotype", stream);
  }
  ...
  public class SbjPhe {
    ...
    public SbjPhe insertPhe(
      ...
      execute(
          "INSERT INTO phenotype (subject_id, created_at, code_system, code, unit, number_value)"
              + " VALUES ("
              + String.join(
                  ", ",
                  sbjId.toString(),
